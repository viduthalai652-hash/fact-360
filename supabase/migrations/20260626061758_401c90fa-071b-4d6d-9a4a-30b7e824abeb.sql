...
-- =========================================================
-- 6. Purchases (Razorpay placeholder)
-- =========================================================
create table public.purchases (
  ...
  order_id text,
  payment_id text,
  status text not null default 'pending', -- pending|paid|failed|mock
  created_at timestamptz not null default now()
);
...
begin
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_fact,'governance','Governance Architecture',20,1) returning id into v_section;
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_fact,'people','People Architecture',18,2) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_fact,'operations','Operations Architecture',17,3) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_fact,'financial','Financial Architecture',20,4) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_fact,'brand','Brand & Market Architecture',13,5) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_fact,'technology','Technology Architecture',12,6) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_lead,'vision','Vision & Purpose',25,1) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_lead,'people','People & Trust',25,2) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_lead,'execution','Execution & Discipline',25,3) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
  ...
  insert into public.sections (assessment_id, slug, name, weight, order_index) values
    (v_lead,'growth','Growth Mindset',25,4) returning id into v_section;
  insert into public.questions (section_id,text,options,order_index) values
